...
void AcDimmer::setup() {
  ...
  if (setup_zero_cross_pin) {
    ...
    this->zero_cross_pin_->attach_interrupt(
        &AcDimmerDataStore::s_gpio_intr, &this->store_,
        this->zero_crossing_type_ == ZeroCrossingType::ZERO_CROSSING_TYPE_FALLING_EDGE ? gpio::INTERRUPT_FALLING_EDGE
